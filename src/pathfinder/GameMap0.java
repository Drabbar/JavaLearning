...
public class GameMap0 implements TileBasedMap {
	public static final int WIDTH = logic.Main.world1.length;
	public static final int HEIGHT = logic.Main.world1[0].length;
	...
	public GameMap0(int nx, int ny) {
		for (int y = 0; y < terrain[0].length; y++) {
			for (int x = 0; x < terrain.length; x++) {
				terrain[x][y] = logic.Main.world1[x][y][1];
			}
		}
		units[nx][ny] = 2;
	}
